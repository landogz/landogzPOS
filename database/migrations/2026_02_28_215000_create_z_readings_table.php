...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('z_readings', function (Blueprint $table) {
            ...
            $table->decimal('void_trans_amount', 12, 2)->default(0);
            ...
            $table->decimal('sc_vat', 12, 2)->default(0);
            $table->decimal('pwd_discount', 12, 2)->default(0);
            $table->decimal('pwd_vat', 12, 2)->default(0);
            ...
            $table->decimal('change_fund', 12, 2)->default(0);
            $table->decimal('pull_outs', 12, 2)->default(0);
            $table->decimal('amount_submitted', 12, 2)->nullable();
            $table->decimal('amount_over', 12, 2)->nullable();
            $table->decimal('old_accumulated_sales', 14, 2)->default(0);
            $table->decimal('new_accumulated_sales', 14, 2)->default(0);
            $table->string('store_manager_name', 120)->nullable();
