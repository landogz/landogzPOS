...
class ZReading extends Model
{
    ...
    protected $fillable = [
        'branch_id', 'terminal_id', 'day_session_id', 'z_counter',
        'or_series_start', 'or_series_end',
        ...
        'old_accumulated_sales', 'new_accumulated_sales',
        'store_manager_name', 'reporting_date', 'period_from', 'period_to', 'printed_at', 'cash_count',
    ];
    ...
    protected $casts = [
        ...
        'old_accumulated_sales' => 'decimal:2',
        'new_accumulated_sales' => 'decimal:2',
    ...
    public function daySession(): BelongsTo
    {
        return $this->belongsTo(DaySession::class);
    }
}
